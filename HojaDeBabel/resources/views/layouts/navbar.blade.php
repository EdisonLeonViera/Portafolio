<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        ...
        <!-- Logo a la izquierda -->
        <a class="navbar-brand" href="{{ route('home.inicio') }}">
            <img src="{{ asset('img/icons/logo.png') }}" alt="logo" height="40">
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarContent">
            <ul class="navbar-nav mb-2 mb-lg-0 align-items-center">
                <li class="nav-item"><a class="nav-link nombre_link inicio" href="{{ route('home.inicio') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
                    <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5z"></path>
                    </svg>
                    Inicio</a>
                </li>
                <li class="nav-item"><a class="nav-link nombre_link" href="{{ route('nosotros.us') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                    <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z"></path>
                    </svg>
                    Equipo</a>
                </li>
                <li class="nav-item"><a class="nav-link nombre_link" href="{{ route('biblioteca.biblioteca') }}">
                ...
                <li class="nav-item"><a class="nav-link nombre_link" href="{{ route('hemeroteca.hemeroteca') }}">
                ...
                <li class="nav-item"><a class="nav-link nombre_link" href="{{ route('galeria.galeria') }}">
                ...
                <li class="nav-item"><a class="nav-link nombre_link" href="{{ route('cineteca.cineteca') }}">
