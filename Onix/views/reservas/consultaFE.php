        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" id="intervalo">
            	...
            	<div class="marcoDeInfo" id="marcoDeInfo">
            		<div id="info">
            			<div class="container">
            				<form action="<?php echo constant('URL'); ?>/reservar/newConsultaFE" method="POST" onsubmit="return validaFecha();">
            					<div class="row mt-1">
            						<div class="col-2">
            							<h6>Especialidad:</h6>
            						</div>
            						<div class="col-4">
            							<select name="especialidad" id="especialidad" class="form-select form-select-sm" aria-label=".form-select-sm example" required>
            					...
            					<div class="row mt-2">
            						<div class="col-6 text-center">
            							<button type=" submit" class="btn btn-primary" name="btnBuscaHora" id="btnBuscaHora">Buscar Hora</button>
            						</div>
            					</div>
            				</form>
            			</div>
